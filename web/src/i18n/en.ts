...
const en: TranslationMap = {
  ...
  businessRegistration: {
    ...
    phoneHint: 'International format, e.g. +972501234567. This is also your sign-in number.',
    ...
    alreadyPendingTitle: 'Request already pending',
    alreadyPendingMessage: 'You already have a business registration request pending review. No need to submit again.',
