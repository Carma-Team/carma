...
@pytest.mark.parametrize(
    "typed",
    ["K7MP3XQZR9", "k7mp3xqzr9", "K7MP3-XQZR9", "k7mp3 xqzr9", "  K7MP3-XQZR9  ", "K7MP3_XQZR9"],
)
def test_every_way_a_cashier_might_type_it_resolves_the_same(typed: str) -> None:
    """Lower case, the grouping the app displays, and a stray space either side."""
