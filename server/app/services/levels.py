...
LEVELS: tuple[LevelDef, ...] = (
    ...
    LevelDef(2, "זהיר", "Cautious", 500, 0, 1.02, "#22c55e", "compass-outline", ("גישה לטבלת המובילים",)),
    LevelDef(3, "מרוכז", "Focused", 1_500, 5, 1.04, "#16a34a", "aperture-outline", ("5% הנחה בחנות הפרסים",)),
    LevelDef(
        4, "מיומן", "Skilled", 3_500, 5, 1.06, "#0d9488", "flash-outline", ("5% הנחה בחנות הפרסים", "פרסים בלעדיים")
    ),
    LevelDef(
        5, "חד", "Sharp", 7_000, 10, 1.08, "#3b82f6", "shield-checkmark-outline", ("10% הנחה", "מכפיל נקודות x1.08")
    ),
    LevelDef(6, "מומחה", "Expert", 12_000, 10, 1.10, "#6366f1", "flame-outline", ("10% הנחה", "גישה VIP לפרסים")),
    LevelDef(7, "אשף", "Wizard", 20_000, 15, 1.12, "#8b5cf6", "star-outline", ("15% הנחה", "מכפיל נקודות x1.12")),
    LevelDef(8, "מאסטר", "Master", 32_000, 15, 1.15, "#f59e0b", "diamond-outline", ("15% הנחה", "תג מאסטר")),
    LevelDef(
        9, "גנרל הכביש", "Road General", 50_000, 20, 1.18, "#ef4444", "trophy-outline", ("20% הנחה", "VIP לכל הפרסים")
    ),
    LevelDef(10, "אגדה", "Legend", 75_000, 25, 1.25, "#f97316", "ribbon-outline", ("25% הנחה", "מכפיל נקודות x1.25")),
)
