...
@rewards_router.get("", response_model=RewardListOut, response_model_by_alias=True,
...
@rewards_router.post("/{reward_id}/redeem", response_model=VoucherResponse, response_model_by_alias=True,
...
@vouchers_router.get("", response_model=VoucherListOut, response_model_by_alias=True,
