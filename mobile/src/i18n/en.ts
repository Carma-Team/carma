...
const en: TranslationMap = {
  ...
  dashboard: {
    ...
    deleteAllConfirm: 'Delete every trip from your history? This hides them on this device only.',
  ...
  trip: {
    ...
    duration: 'Time', distance: 'Distance', score: 'Score',
    ...
    nightBonusFull: 'You earned the full night bonus on this trip.',
    nightBonusDouble: 'A score of 100 doubles your points this hour.',
    nightBonusHalf: 'A score of 100 adds 50% to your points this hour.',
    occupancyPassengerCta: "I wasn't driving this trip",
    occupancyExplainer: 'This records who was behind the wheel. The trip stays in your history either way.',
  ...
  common: {
    ...
    tripsDeletedDesc: 'Your history is empty on this device',
    restartRequired: 'Reopen the app',
    restartRequiredDesc: 'Close CARMA and open it again so the writing direction updates.',
