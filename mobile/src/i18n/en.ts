...
const en: TranslationMap = {
  ...
  profile: {
    ...
    driveModeUnavailableTitle: 'This feature isn\'t available yet',
    driveModeUnavailableMessage: 'We\'re still improving automatic trip detection and apologize for the inconvenience. It will be available soon.',
    noDeviceSelectedTitle: 'No device selected',
    noDeviceSelectedMessage: 'No Bluetooth device was selected, so automatic drive mode will stay off.',
