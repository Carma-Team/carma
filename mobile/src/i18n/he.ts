...
const he = {
  ...
  profile: {
    ...
    driveModeUnavailableTitle: 'התכונה עדיין לא זמינה',
    driveModeUnavailableMessage: 'אנחנו עדיין משפרים את הזיהוי האוטומטי של נסיעות ומתנצלים על אי הנוחות. התכונה תהיה זמינה בקרוב.',
    noDeviceSelectedTitle: 'לא נבחר מכשיר',
    noDeviceSelectedMessage: 'לא נבחר מכשיר Bluetooth, ולכן מצב הנסיעה האוטומטי יישאר כבוי.',
  ...
  business: {
    ...
    form: {
      ...
      stockLabel: 'כמות במלאי (השאר ריק לכמות ללא הגבלה)',
      stockInvalid: 'כמות במלאי חייבת להיות מספר שלם, או ריקה לכמות ללא הגבלה',
      isActive: 'הטבה פעילה',
      activeLabel: 'פעיל',
