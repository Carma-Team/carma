 ...
 *        The rules it enforces are Dan's: Rule 3 delegates entirely to `fraud-detection/`.
...
import { FraudDetector, FRAUD_SCORE_THRESHOLD } from '@/lib/fraud-detection/FraudDetector';
